...
# Load data
#
path_dir = '/home/nazarov_group/data/cmv_VDJtools_format_reads'
...
num_iterations = 10  # Optimization steps
num_replicas = 100  # Number of attempts to find the best fit
